"""Detector checking for product recommendation/advice intent."""

import re
import time

from src.ai_agents.enums.intent import IntentEnum
from src.ai_agents.intent.constants import RECOMMENDATION_KEYWORDS
from src.ai_agents.intent.result import DetectorResult


class RecommendationDetector:
    """Detector identifying when users want shopping recommendations or advice."""

    @property
    def name(self) -> str:
        """The name of the detector."""
        return "RecommendationDetector"
    ...
    def detect(self, query: str) -> DetectorResult:
        ...
        # Scan for word boundary matches on recommendation keywords
        ...
        return DetectorResult(
            ...
            intent=IntentEnum.SHOPPING_ADVICE,
